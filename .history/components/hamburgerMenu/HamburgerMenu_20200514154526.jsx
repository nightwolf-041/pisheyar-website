...
import { faSignInAlt , faHome, faObjectGroup, faInfoCircle, faMobile, faBlog, faPhoneSquareAlt } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className={props.toggle ? classes.hamburgerMenuToggle : classes.hamburgerMenu}>
            ...
            renderTrackHorizontal={({ style, ...props }) =>
                ...
                smooth={true} duration={500} className={classes.hamburgerMenuItemLink7}>
                    <FontAwesomeIcon icon={faPhoneSquareAlt} className={classes.hamburgerMenuItem} />
                </Link> 
            </Scrollbars>
        </div>
    )
