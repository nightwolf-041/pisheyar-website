...
class Select extends Component {
  ...
  renderOptions = () => {
    ...
    return (
      <div className={this.props.optionbox}>
  ...
  renderOption = (option, index) => {
    ...
    if (selected) className.push(classes.optionSelected)
    if (index === focusedValue) className.push(classes.optionFocused)
  ...
  render() {
    const { label, propClassname } = this.props
    const { isOpen } = this.state
    ...
    return (
      ...
      >
        ...
        <div className={propClassname} onClick={ this.onClick }>
          { this.renderValues() }
...
const ChevronDown = () => (
  <svg viewBox="0 0 10 7" className={classes.svg}>
...
const ChevronUp = () => (
  <svg viewBox="0 0 10 8" className={classes.svg}>
...
const X = () => (
  <svg viewBox="0 0 16 16" className={classes.svg}>
