    ...
    let myTimer = setInterval(() => {
      this.setState({imgKey: this.state.imgKey += 1})
        ...
        if(this.state.imgKey === 1){
          ...
          .to(this.headerImage1box, 0.5, {autoAlpha: 0, top: '27rem'})
          .to(this.headerImage1box, 0.5, {top: '21rem', display: 'none'})
          this.headerTitle3boxTween = new TimelineLite()
          .to(this.headerImage3box, 0.5, {autoAlpha: 0, top: '27rem'})
          .to(this.headerImage3box, 0.5, {top: '21rem', display: 'none'})
        }
