    ...
    let myTimer = setInterval(() => {
      this.setState({imgKey: this.state.imgKey += 1})
        ...
        if(this.state.imgKey === 2){
          this.paginate3Tween = TweenLite.to(this.paginate2, 0.3, {backgroundColor: 'rgba(11, 16, 51, 1)', width: 18, height: 18})
          this.paginate1Tween = TweenLite.to(this.paginate1, 0.3, {backgroundColor: 'rgba(11, 16, 51, 0.74)', width: 10, height: 10})
          this.paginate2Tween = TweenLite.to(this.paginate3, 0.3, {backgroundColor: 'rgba(11, 16, 51, 0.74)', width: 10, height: 10})
        ...
        if(this.state.imgKey === 3){
          this.paginate1Tween = TweenLite.to(this.paginate2, 0.3, {backgroundColor: 'rgba(11, 16, 51, 1)', width: 18, height: 18})
          this.paginate2Tween = TweenLite.to(this.paginate1, 0.3, {backgroundColor: 'rgba(11, 16, 51, 0.74)', width: 10, height: 10})
          this.paginate3Tween = TweenLite.to(this.paginate3, 0.3, {backgroundColor: 'rgba(11, 16, 51, 0.74)', width: 10, height: 10})
