    ...
    let myTimer = setInterval(() => {
      this.setState({imgKey: this.state.imgKey += 1})
        ...
        if(this.state.imgKey === 1){
          ...
          .to(this.headerTitle1box, 0.5, {autoAlpha: 0, y: 20})
          .to(this.headerTitle1box, 0.5, {y: -20, display: 'none'})
          this.headerTitle3boxTween = new TimelineLite()
          .to(this.headerTitle3box, 0.5, {autoAlpha: 0, y: 20})
          .to(this.headerTitle3box, 0.5, {y: -20, display: 'none'})
        }
        ...
        if(this.state.imgKey === 2){
          ...
          .to(this.headerTitle3box, 0.5, {autoAlpha: 1, top: '25rem', display: 'block', delay: 0.5})

          this.headerTitle1boxTween = new TimelineLite()
          .to(this.headerTitle1box, 0.5, {autoAlpha: 0, top: '27rem'})
          .to(this.headerTitle1box, 0.5, {top: '21rem', display: 'none'})
          this.headerTitle2boxTween = new TimelineLite()
          .to(this.headerTitle2box, 0.5, {autoAlpha: 0, top: '27rem'})
          .to(this.headerTitle2box, 0.5, {top: '21rem', display: 'none'})
        }
        ...
        if(this.state.imgKey === 3){
          ...
          .to(this.headerTitle1box, 0.5, {autoAlpha: 1, top: '25rem', display: 'block', delay: 0.5})

          this.headerTitle3boxTween = new TimelineLite()
          .to(this.headerTitle3box, 0.5, {autoAlpha: 0, top: '27rem'})
          .to(this.headerTitle3box, 0.5, {top: '21rem', display: 'none'})
          this.headerTitle2boxTween = new TimelineLite()
          .to(this.headerTitle2box, 0.5, {autoAlpha: 0, top: '27rem'})
          .to(this.headerTitle2box, 0.5, {top: '21rem', display: 'none'})
        }
          ...
          <section name="topPage" className={classes.topPageSection}>
            ...
            <div className="container">
              ...
              ref={div => this.headerButtonbox1Box = div}>
                ...
                ref={div => this.headerButtonbox1 = div}>
                  <button className={classes.homeHeaderButtonboxBtn}>مشاهده</button>
                  <p className={classes.homeHeaderButtonboxText}>
                    همین حالا از خدمات ما مطلع شوید
                  </p>
              ...
              ref={div => this.headerButtonbox2Box = div}>
                <div className={classes.homeHeaderButtonboxKeeper}
                ref={div => this.headerButtonbox2 = div}>
                  <button className={classes.homeHeaderButtonboxBtn}>مشاهده</button>
                  <p className={classes.homeHeaderButtonboxText}>
                    همین حالا از خدمات ما مطلع شوید
                  </p>
              ...
              ref={div => this.headerButtonbox3Box = div}>
                <div className={classes.homeHeaderButtonboxKeeper}
                ref={div => this.headerButtonbox3 = div}>
                  <button className={classes.homeHeaderButtonboxBtn}>مشاهده</button>
                  <p className={classes.homeHeaderButtonboxText}>
                    همین حالا از خدمات ما مطلع شوید
                  </p>
