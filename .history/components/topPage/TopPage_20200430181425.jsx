    ...
    setInterval(() => {
      ...
      switch (imgKey) {
        ...
        case 1:
          ...
          tl
          .add({
            targets: ['#headerImage1box', '#headerImage3box'],
            top: "15rem",
            opacity: 0,
            zIndex: 0
          })
          .add({
            targets: '#headerImage2box',
            top: "18rem",
            opacity: 1,
            zIndex: 5
          }, 750)
          ...
          timeLTitle
          .add({
            targets: ['#headerTitle1box', '#headerTitle3box'],
            top: "22rem",
            opacity: 0,
            zIndex: -5
          })
          .add({
            targets: '#headerTitle2box',
            top: "25rem",
            opacity: 1,
            zIndex: 5
          }, 750)
          ...
          timeLButtons
          .add({
            targets: ['#headerButtonbox1Box', '#headerButtonbox3Box'],
            right: "40%",
            opacity: 0,
            zIndex: -5
          })
          .add({
            targets: '#headerButtonbox2Box',
            right: "45%",
            opacity: 1,
            zIndex: 5
          }, 750)
          ...
          case 2:
            ...
            tl2
            .add({
              targets: ['#headerImage2box', '#headerImage1box'],
              top: "15rem",
              opacity: 0,
              zIndex: -5
            })
            .add({
              targets: '#headerImage3box',
              top: "18rem",
              opacity: 1,
              zIndex: 5
            }, 750)
            ...
            timeLTitle2
            .add({
              targets: ['#headerTitle2box', '#headerTitle1box'],
              top: "22rem",
              opacity: 0,
              zIndex: -5
            })
            .add({
              targets: '#headerTitle3box',
              top: "25rem",
              opacity: 1,
              zIndex: 5
            }, 750)
            ...
            timeLButtons2
            .add({
              targets: ['#headerButtonbox2Box', '#headerButtonbox1Box'],
              right: "40%",
              opacity: 0,
              zIndex: -5
            })
            .add({
              targets: '#headerButtonbox3Box',
              right: "45%",
              opacity: 1,
              zIndex: 5
            }, 750)
          ...
          case 3:
            ...
            tl3
            .add({
              targets: ['#headerImage3box', '#headerImage2box'],
              top: "15rem",
              opacity: 0,
              zIndex: -5
            })
            .add({
              targets: '#headerImage1box',
              top: "18rem",
              opacity: 1,
              zIndex: 5
            }, 750)
          ...
          let timeLTitle3 = anime.timeline({
            ...
            timeLTitle3
            .add({
              targets: ['#headerTitle3box', '#headerTitle2box'],
              top: "22rem",
              opacity: 0,
              zIndex: -5
            })
            .add({
              targets: '#headerTitle1box',
              top: "25rem",
              opacity: 1,
              zIndex: 5
            }, 750)
            ...
            timeLButtons3
            .add({
              targets: ['#headerButtonbox3Box', '#headerButtonbox2Box'],
              right: "40%",
              opacity: 0,
              zIndex: -5
            })
            .add({
              targets: '#headerButtonbox1Box',
              right: "45%",
              opacity: 1,
              zIndex: 5
            }, 750)
