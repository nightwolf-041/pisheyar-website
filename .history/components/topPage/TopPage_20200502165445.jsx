        ...
        <div className={classes.homeHeader}>
          ...
          <div className="container">
            <div className={classes.homeHeaderPaginateBox}>
              <div className={classes.homeHeaderPaginate1} ref={Paginate1}></div>
              <div className={classes.homeHeaderPaginate2} ref={Paginate2}></div>
              <div className={classes.homeHeaderPaginate3} ref={Paginate3}></div>
            </div>
