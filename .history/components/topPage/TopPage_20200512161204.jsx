    ...
    let myTimer = setInterval(() => {
      this.setState({imgKey: this.state.imgKey += 1})
        ...
        if(this.state.imgKey === 1){
          ...
          .to(this.headerImage2box, 0.1, {autoAlpha: 0, top: '14rem', delay: 0.5})
          .to(this.headerImage2box, 0.5, {autoAlpha: 1, top: '17rem', display: 'block'})

          this.headerImage1boxTween = new TimelineLite()
          .to(this.headerImage1box, 0.5, {autoAlpha: 1, top: '19rem'})
          .to(this.headerImage1box, 0.5, {autoAlpha: 0, top: '17rem', display: 'none'})

          this.headerImage3boxTween = new TimelineLite()
          .to(this.headerImage3box, 0.5, {autoAlpha: 1, top: '19rem'})
          .to(this.headerImage3box, 0.5, {autoAlpha: 0, top: '17rem', display: 'none'})
        }
