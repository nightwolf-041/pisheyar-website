        ...
        if(imgKey === 1){
          ...
          tl1for3
            ...
            .add({
              ...
              opacity: 1,
              complete: () => {
                document.getElementById('headerImage3box').style.display = 'block'
              }
          })
          ...
          tl1for2
            ...
            .add({
              ...
              opacity: 0,
              complete: () => {
                document.getElementById('headerImage2box').style.display = 'none'
              }
          })
          ...
          tl1for1
            ...
            .add({
              ...
              opacity: 0,
              complete: () => {
                document.getElementById('headerImage1box').style.display = 'none'
              }
          })
          ...
          if(imgKey === 2) {
            ...
            tl2for2
              ...
              .add({
                ...
                opacity: 1,
                complete: () => {
                  document.getElementById('headerImage2box').style.display = 'block'
                }
            })
            ...
            tl2for3
              ...
              .add({
                ...
                opacity: 0,
                complete: () => {
                  document.getElementById('headerImage3box').style.display = 'none'
                }
            })
          ...
          if(imgKey === 3){
            ...
            tl3for1
              ...
              .add({
                ...
                opacity: 1,
                complete: () => {
                  document.getElementById('headerImage1box').style.display = 'block'
                }
            })
