    ...
    setInterval(() => {
      ...
      switch (imgKey) {
        ...
        case 1:
          ...
          tl
          .add({
            targets: [headerImage1.current, headerImage3.current],
            translateY: 120,
            opacity: 0
          })
          .add({
            targets: [headerImage1box.current, headerImage3box.current],
            display: 'none',
            opacity: 0
          })
          .add({
          ...
          timeLTitle
          .add({
            targets: [headerTitle1.current, headerTitle3.current],
            translateY: -80,
            opacity: 0
          })
          .add({
            targets: [headerTitle1box.current, headerTitle3box.current],
            display: 'none',
            opacity: 0
          })
          .add({
          ...
          timeLButtons
          .add({
            targets: [headerButtonbox1.current, headerButtonbox3.current],
            translateX: 140,
            opacity: 0
          })
          .add({
            targets: [headerButtonbox1Box.current, headerButtonbox3Box.current],
            display: 'none',
            opacity: 0
          })
          .add({
          ...
          case 2:
            ...
            tl2
            .add({
              targets: [headerImage2.current, headerImage1.current],
              translateY: 120,
              opacity: 0
            })
            .add({
              targets: [headerImage2box.current, headerImage1box.current],
              display: 'none',
              opacity: 0
            })
            .add({
            ...
            timeLTitle2
            .add({
              targets: [headerTitle2.current, headerTitle1.current],
              translateY: -80,
              opacity: 0
            })
            .add({
              targets: [headerTitle2box.current, headerTitle1box.current],
              display: 'none',
              opacity: 0
            })
            .add({
            ...
            timeLButtons2
            .add({
              targets: [headerButtonbox2.current, headerButtonbox1.current],
              translateX: 140,
              opacity: 0
            })
            .add({
              targets: [headerButtonbox2Box.current, headerButtonbox1Box.current],
              display: 'none',
              opacity: 0
            })
            .add({
          ...
          case 3:
            ...
            tl3
            .add({
              targets: [headerImage3.current, headerImage2.current],
              translateY: 120,
              opacity: 0
            })
            .add({
              targets: [headerImage3box.current, headerImage2box.current],
              display: 'none',
              opacity: 0
            })
            .add({
          ...
          let timeLTitle3 = anime.timeline({
            ...
            timeLTitle3
            .add({
              targets: [headerTitle3.current, headerTitle2.current],
              translateY: -80,
              opacity: 0
            })
            .add({
              targets: [headerTitle3box.current, headerTitle2box.current],
              display: 'none',
              opacity: 0
            })
            .add({
            ...
            timeLButtons3
            .add({
              targets: [headerButtonbox3.current, headerButtonbox2.current],
              translateX: 140,
              opacity: 0
            })
            .add({
              targets: [headerButtonbox3Box.current, headerButtonbox2Box.current],
              display: 'none',
              opacity: 0
            })
            .add({
