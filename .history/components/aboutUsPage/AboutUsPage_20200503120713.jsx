            ...
            <div className="container">
                ...
                <div className={classes.aboutUsRightBottom}>
                    <div className={classes.aboutUsRightBottomItem}>
                        ...
                        <h4 className={aboutUsRightBottomItemTitle}>بهترین متخصصین</h4>
                        <h4 className={aboutUsRightBottomItemSubtitle}>
                            فراهم آورنده ی بهترین خدمات صنعتی برای متقاضیان
                        </h4>
                    </div>
                    <div className={classes.aboutUsRightBottomItem}>
                        <img src="icon-close.png" alt="icon" className={classes.aboutUsRightBottomItemIcon} />
                        <h4 className={aboutUsRightBottomItemTitle}>بهترین خدمات</h4>
                        <h4 className={aboutUsRightBottomItemSubtitle}>
                            فراهم آورنده ی بهترین خدمات صنعتی برای متقاضیان
                        </h4>
                    </div>
                    <div className={classes.aboutUsRightBottomItem}>
                        <img src="icon-close.png" alt="icon" className={classes.aboutUsRightBottomItemIcon} />
                        <h4 className={aboutUsRightBottomItemTitle}>بهترین کیفیت</h4>
                        <h4 className={aboutUsRightBottomItemSubtitle}>
                            فراهم آورنده ی بهترین خدمات صنعتی برای متقاضیان
                        </h4>
                    </div>
                    <div className={classes.aboutUsRightBottomItem}>
                        <img src="icon-close.png" alt="icon" className={classes.aboutUsRightBottomItemIcon} />
                        <h4 className={aboutUsRightBottomItemTitle}>پاسخگویی سریع</h4>
                        <h4 className={aboutUsRightBottomItemSubtitle}>
                            فراهم آورنده ی بهترین خدمات صنعتی برای متقاضیان
                        </h4>
                    </div>
