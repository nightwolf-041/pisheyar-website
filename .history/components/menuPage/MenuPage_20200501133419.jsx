...
const MenuPage = () => {
    ...
    let [displayBlock1, setDisplayBlock1] = useState()
    let [displayBlock2, setDisplayBlock2] = useState()
    let [displayBlock3, setDisplayBlock3] = useState()
    let [displayBlock4, setDisplayBlock4] = useState()
    let [displayBlock5, setDisplayBlock5] = useState()
    let [displayBlock6, setDisplayBlock6] = useState()
    let [displayBlock7, setDisplayBlock7] = useState()
    let [displayBlock8, setDisplayBlock8] = useState()
