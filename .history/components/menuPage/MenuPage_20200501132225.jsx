...
const MenuPage = () => {
    ...
    let [displayBlock1, setDisplayBlock1] = useState(false)
    let [displayBlock2, setDisplayBlock2] = useState(false)
    let [displayBlock3, setDisplayBlock3] = useState(false)
    let [displayBlock4, setDisplayBlock4] = useState(false)
    let [displayBlock5, setDisplayBlock5] = useState(false)
    let [displayBlock6, setDisplayBlock6] = useState(false)
    let [displayBlock7, setDisplayBlock7] = useState(false)
    let [displayBlock8, setDisplayBlock8] = useState(false)
    ...
    return(
        <div className={classes.circleMenuMainBox}>
             ...
             className={displayBlock1 ? classes.circleMenuMainImage1 : classes.circleMenuMainImage1None}
             ref={imageee1} />
             <img id="imageee2" src="/about-man.png" alt=""
             className={displayBlock2 ? classes.circleMenuMainImageOther : classes.circleMenuMainImageOtherNone}
             ref={imageee2} />
             <img id="imageee3" src="/Background.png" alt=""
             className={displayBlock3 ? classes.circleMenuMainImageOther : classes.circleMenuMainImageOtherNone}
             ref={imageee3} />
             <img id="imageee4" src="/stock.jpg" alt=""
             className={displayBlock4 ? classes.circleMenuMainImageOther : classes.circleMenuMainImageOtherNone}
             ref={imageee4} />
