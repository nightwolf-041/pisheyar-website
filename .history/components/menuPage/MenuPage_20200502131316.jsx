...
const MenuPage = () => {
    ...
    useEffect(() => {
        ...
        setInterval(() => {
            ...
            // easing: 'linear'
                ...
                anime({
                    targets: [circleMenuItemIconbox1.current, circleMenuItemIconbox2.current, circleMenuItemIconbox3.current, circleMenuItemIconbox4.current, circleMenuItemIconbox6.current, circleMenuItemIconbox7.current, circleMenuItemIconbox8.current],
                    backgroundColor: '#0b1033'
                })
            }
            ...
            if(subDeg === 225) {
                ...
                anime({
                    targets: [circleMenuItemIconbox1.current, circleMenuItemIconbox2.current, circleMenuItemIconbox3.current, circleMenuItemIconbox4.current, circleMenuItemIconbox5.current, circleMenuItemIconbox7.current, circleMenuItemIconbox8.current],
                    backgroundColor: '#0b1033'
                })
            }
            ...
            // easing: 'linear'
                ...
                anime({
                    targets: [circleMenuItemIconbox1.current, circleMenuItemIconbox2.current, circleMenuItemIconbox3.current, circleMenuItemIconbox4.current, circleMenuItemIconbox5.current, circleMenuItemIconbox6.current, circleMenuItemIconbox8.current],
                    backgroundColor: '#0b1033'
                })
            }
            ...
            // easing: 'linear'
                ...
                anime({
                    targets: [circleMenuItemIconbox1.current, circleMenuItemIconbox2.current, circleMenuItemIconbox3.current, circleMenuItemIconbox4.current, circleMenuItemIconbox5.current, circleMenuItemIconbox6.current, circleMenuItemIconbox7.current],
                    backgroundColor: '#0b1033'
                })
            }
    ...
    const handleTurn = () => {
        ...
        anime({
            targets: [circleMenuItemIconbox2.current, circleMenuItemIconbox3.current, circleMenuItemIconbox4.current, circleMenuItemIconbox5.current, circleMenuItemIconbox6.current, circleMenuItemIconbox7.current, circleMenuItemIconbox8.current],
            backgroundColor: '#0b1033'
        })
    }
    const handleTurn2 = () => {
        ...
        anime({
            targets: [circleMenuItemIconbox1.current, circleMenuItemIconbox3.current, circleMenuItemIconbox4.current, circleMenuItemIconbox5.current, circleMenuItemIconbox6.current, circleMenuItemIconbox7.current, circleMenuItemIconbox8.current],
            backgroundColor: '#0b1033'
        })
    }
    const handleTurn3 = () => {
        ...
        anime({
            targets: [circleMenuItemIconbox1.current, circleMenuItemIconbox2.current, circleMenuItemIconbox4.current, circleMenuItemIconbox5.current, circleMenuItemIconbox6.current, circleMenuItemIconbox7.current, circleMenuItemIconbox8.current],
            backgroundColor: '#0b1033'
        })
    }
    const handleTurn4 = () => {
        ...
        anime({
            targets: [circleMenuItemIconbox1.current, circleMenuItemIconbox2.current, circleMenuItemIconbox3.current, circleMenuItemIconbox5.current, circleMenuItemIconbox6.current, circleMenuItemIconbox7.current, circleMenuItemIconbox8.current],
            backgroundColor: '#0b1033'
        })
    }
    const handleTurn5 = () => {
