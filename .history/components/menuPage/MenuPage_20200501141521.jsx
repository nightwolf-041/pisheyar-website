...
const MenuPage = () => {
    ...
    useEffect(() => {
        ...
        setInterval(() => {
            ...
            if(subDeg === 0) {
                ...
                anime({
                    targets: [centerBox1.current,centerBox2.current, centerBox4.current], 
                    opacity: 0,
                    begin: () => {
            ...
            if(subDeg === 45) {
                ...
                anime({
                    targets: [centerBox1.current, centerBox2.current, centerBox3.current], 
                    opacity: 0,
                    begin: () => {
                        document.getElementById('centerBox1').style.display = 'none'
                        document.getElementById('centerBox2').style.display = 'none'
            ...
            if(subDeg === 90) {
                ...
                anime({
                    targets: [centerBox1.current, centerBox3.current, centerBox4.current], 
                    opacity: 0,
                    begin: () => {
                        document.getElementById('centerBox1').style.display = 'none'
                        document.getElementById('centerBox3').style.display = 'none'
    ...
    const handleTurn = () => {
        ...
        anime({
            targets: [centerBox4.current, centerBox2.current, centerBox3.current], 
            opacity: 0,
            begin: () => {
                document.getElementById('centerBox4').style.display = 'none'
                document.getElementById('centerBox2').style.display = 'none'
    ...
    const handleTurn3 = () => {
        ...
        anime({
            targets: [centerBox1.current, centerBox4.current, centerBox3.current], 
            opacity: 0,
            begin: () => {
                document.getElementById('centerBox1').style.display = 'none'
                document.getElementById('centerBox4').style.display = 'none'
    ...
    return(
        <div className={classes.circleMenuMainBox}>
             ...
             <div id="centerBox1" className={classes.circleMenuMainCenterBox}
             ref={centerBox1}></div>
