...
const MenuPage = () => {
    ...
    let [displayBlock1, setDisplayBlock1] = useState(true)
    let [displayBlock2, setDisplayBlock2] = useState(true)
    let [displayBlock3, setDisplayBlock3] = useState(true)
    let [displayBlock4, setDisplayBlock4] = useState(true)
    let [displayBlock5, setDisplayBlock5] = useState(true)
    let [displayBlock6, setDisplayBlock6] = useState(true)
    let [displayBlock7, setDisplayBlock7] = useState(true)
    let [displayBlock8, setDisplayBlock8] = useState(true)
