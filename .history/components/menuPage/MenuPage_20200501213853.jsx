...
const MenuPage = () => {
    ...
    let disblerPrev = false
    let disblerNext = false
    ...
    console.log(disblerPrev);

    return(
        <>
        <div className={classes.circleMenuMainBox}>
            <button className={classes.circleMenuMainBoxPrev} disabled={disblerPrev} onClick={(e) => prevHandlerFunc(e)}
            ref={prevHandler}>قبلی</button>
            <button className={classes.circleMenuMainBoxNext} disabled={disblerNext} onClick={(e) => nextHandlerFunc(e)}
