    ...
    useEffect(() => {
        ...
        setInterval(() => {
            ...
            if(subDeg === 0) {
                ...
                anime({
                    targets: [circleMenuItemIconbox2.current, circleMenuItemIconbox3.current, circleMenuItemIconbox4.current, circleMenuItemIconbox5.current, circleMenuItemIconbox6.current, circleMenuItemIconbox7.current, circleMenuItemIconbox8.current, circleMenuItemIconbox1.current],
