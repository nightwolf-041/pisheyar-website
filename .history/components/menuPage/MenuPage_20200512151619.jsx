...
class MenuPage extends Component {
    ...
    componentDidMount() {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.3, {rotation: `-${this.state.deg}deg`, ease: Bounce.easeInOut});

        setInterval(() => {
            this.setState({deg: this.state.deg += 45})
            
            this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: `-${this.state.deg}deg`, ease: Bounce.easeInOut});
