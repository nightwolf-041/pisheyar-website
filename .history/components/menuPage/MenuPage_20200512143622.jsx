    ...
    componentDidMount() {
        ...
        setInterval(() => {
            ...
            if(this.state.deg === 45) {
                if(toggleOnce) {
                    this.centerBox2Tween = TimelineLite.to(this.centerBox2, 0.3, {display: 'block', autoAlpha: 1, scale: 1.3}).to(this.centerBox2, 0.3, {scale: 0.7}).to(this.centerBox2, 0.3, {scale: 1})
