...
import { TimelineLite, TweenLite, Bounce, Back } from "gsap";
...
class MenuPage extends Component {
    ...
    componentDidMount() {
        ...
        setInterval(() => {
            ...
            this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: `-${this.state.deg}deg`, ease: Back.easeOut});
