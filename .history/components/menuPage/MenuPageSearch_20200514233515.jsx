...
class MenuPageSearch extends Component {
    ...
    // countries
        ...
        let charkhIconInterval = setInterval(() => {
            this.searchCharkhIconTween = new TimelineLite()
            .to(this.searchCharkhIcon, 0.3, {width: '4.5rem'})
            .to(this.searchCharkhIcon, 0.3, {width: '3.5rem'})
            .to(this.searchCharkhIcon, 0.4, {width: '4rem'})
        }, 2000);
    }
