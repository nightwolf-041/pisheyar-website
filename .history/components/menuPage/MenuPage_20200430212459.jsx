...
const MenuPage = () => {
    ...
    return(
        <div className={classes.circleMenuMainBox}>
            {degree === 45 ? 
             <img id="imageee" src="/Einweganzug-Karneval.png" alt="" className={classes.circleMenuMainImage} /> : null
            }
            {degree === 90 ? 
             <img id="imageee2" src="/about-man.png" alt="" className={classes.circleMenuMainImage} /> : null
            }
