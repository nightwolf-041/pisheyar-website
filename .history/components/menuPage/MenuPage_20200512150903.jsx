...
class MenuPage extends Component {
    ...
    componentDidMount() {
        ...
        setInterval(() => {
            ...
            this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: `-${this.state.deg}deg`, ease: Bounce.easeOut});
            ...
            if(this.state.deg === 45) {
                if(this.state.toggleOnce) {
                    this.centerBox2Tween = new TimelineLite().to(this.centerBox2, 0.3, {display: 'block', autoAlpha: 1, scale: 1.3}).to(this.centerBox2, 0.3, {scale: 0.7}).to(this.centerBox2, 0.3, {scale: 1})
    ...
    handleTurn = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: 0, ease: Bounce.easeOut});
    ...
    handleTurn2 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: -45, ease: Bounce.easeOut});
    ...
    handleTurn3 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: -90, ease: Bounce.easeOut});
    ...
    handleTurn4 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: -135, ease: Bounce.easeOut});
    ...
    handleTurn5 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: -180, ease: Bounce.easeOut});
    ...
    handleTurn6 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: -225, ease: Bounce.easeOut});
    ...
    handleTurn7 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: -270, ease: Bounce.easeOut});
    ...
    handleTurn8 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.7, {rotation: -315, ease: Bounce.easeOut});
