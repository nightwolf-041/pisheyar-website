...
const MenuPageSearch = () => {
    ...
    useEffect(() => {
        ...
        if(toggleMobile === true) {
            ...
            // anime({
            //     targets: charkhIconMobile.current,
            //     width: '3rem'
            // })
        ...
        <>
            ...
            <div className={classes.menuPageSearchRowMobile} ref={searchRowMobile}>
                ...
                <div className={classes.menuPageSearchLogoboxMobile}>
                    <img src="/home-icon.png" alt="" ref={searchCharkhIconMobile}
                    className={classes.menuPageSearchCharkhIconMobile} ref={charkhIconMobile}
