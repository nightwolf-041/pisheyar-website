...
const MenuPage = () => {
    ...
    return(
        <div className={classes.circleMenuMainBox}>
             <img id="imageee1" src="/Einweganzug-Karneval.png" alt="" className={classes.circleMenuMainImage} />
             <img id="imageee2" src="/about-man.png" alt="" className={classes.circleMenuMainImage} />
             <img id="imageee3" src="/Background.png" alt="" className={classes.circleMenuMainImage} />
             <img id="imageee4" src="/stock.png" alt="" className={classes.circleMenuMainImage} />
