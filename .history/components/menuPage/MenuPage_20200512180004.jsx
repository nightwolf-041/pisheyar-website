...
class MenuPage extends Component {
    ...
    componentDidMount() {
        ...
        let menuPageInterval = setInterval(() => {
            this.setState({deg: this.state.deg += 45})
            
            this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 1.2, {rotation: -this.state.deg, ease: Elastic.easeOut.config( 1, 0.3)});
    ...
    componentWillUnmount() {
        clearInterval(menuPageInterval)
    }
