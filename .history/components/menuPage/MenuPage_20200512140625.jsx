...
class MenuPage extends Component {
    ...
    componentDidMount() {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 0.3, {rotation: `-${deg}deg`, ease: Bounce.easeOut});
        // console.log(deg);
        setInterval(() => {
            deg += 45
            subDeg += 45
            ...
            if(subDeg === 0) {
                this.centerBox1Tween = TweenLite.to(this.centerBox1, 0.3, {display: 'block', autoAlpha: 1, ease: Bounce.easeOut});
            ...
            if(subDeg === 45) {
                ...
                //     })
                // }
                this.centerBox2Tween = TweenLite.to(this.centerBox2, 0.3, {display: 'block', autoAlpha: 1, ease: Bounce.easeOut});
            ...
            if(subDeg === 90) {
                this.centerBox3Tween = TweenLite.to(this.centerBox3, 0.3, {display: 'block', autoAlpha: 1, ease: Bounce.easeOut});
            ...
            if(subDeg === 135) {
                this.centerBox4Tween = TweenLite.to(this.centerBox4, 0.3, {display: 'block', autoAlpha: 1, ease: Bounce.easeOut});
            ...
            if(subDeg === 180) {
                this.centerBox5Tween = TweenLite.to(this.centerBox5, 0.3, {display: 'block', autoAlpha: 1, ease: Bounce.easeOut});
            ...
            if(subDeg === 225) {
                this.centerBox6Tween = TweenLite.to(this.centerBox6, 0.3, {display: 'block', autoAlpha: 1, ease: Bounce.easeOut});
            ...
            if(subDeg === 270) {
                this.centerBox7Tween = TweenLite.to(this.centerBox7, 0.3, {display: 'block', autoAlpha: 1, ease: Bounce.easeOut});
            ...
            if(subDeg === 315) {
                this.centerBox8Tween = TweenLite.to(this.centerBox8, 0.3, {display: 'block', autoAlpha: 1, ease: Bounce.easeOut});
