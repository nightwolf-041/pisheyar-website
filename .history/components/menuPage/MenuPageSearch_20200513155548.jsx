...
class MenuPageSearch extends Component {
    ...
    serachHandler = (e) => {
        ...
        axios.get(‍`http://185.94.97.164/api/Category/SearchByCity/?cityGuid=72ef30ac-b5e1-4302-8133-867379963c92&searchInput=مصنوعات صنعتی`, {}).then(res => {
            console.log(res);
        })
    }
            ...
            <>
                ...
                <div className={classes.menuPageSearchResultBox}>
                    <h1>
                        ...
                        this.state.serachResultMessage : null}
                    </h1>
                </div>
