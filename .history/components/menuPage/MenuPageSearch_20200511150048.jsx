...
MenuPageSearch.getInitialProps = async ctx => {
    const res = await fetch('http://185.94.97.164/api/Account/Provinces')
    const json = await res.json()
    return { contries: json.provinces }
  }
