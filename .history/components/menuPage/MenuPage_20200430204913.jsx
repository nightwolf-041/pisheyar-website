...
const MenuPage = () => {
    ...
    return(
        <div id="circleMenuMain" className={classes.circleMenuMain} ref={circleMenuMain}>
            ...
            <div id="circleMenuItem3" className={classes.circleMenuItem4}>
                <div className={classes.circleMenuItemIconbox} onClick={handleTurn4}>
                <span>4</span>
                </div>
            </div>
            <div id="circleMenuItem3" className={classes.circleMenuItem5}>
                <div className={classes.circleMenuItemIconbox} onClick={handleTurn5}>
                <span>5</span>
                </div>
            </div>
            <div id="circleMenuItem3" className={classes.circleMenuItem6}>
                <div className={classes.circleMenuItemIconbox} onClick={handleTurn6}>
                <span>6</span>
                </div>
            </div>
            <div id="circleMenuItem3" className={classes.circleMenuItem7}>
                <div className={classes.circleMenuItemIconbox} onClick={handleTurn7}>
                <span>7</span>
                </div>
            </div>
            <div id="circleMenuItem3" className={classes.circleMenuItem8}>
