    ...
    componentDidMount() {
        ...
        setInterval(() => {
            ...
            if(subDeg === 0) {
                ...
                this.centerBox2Tween = TweenLite.to(this.centerBox2, 0.3, {display: 'nonr', autoAlpha: 0});
                this.centerBox3Tween = TweenLite.to(this.centerBox2, 0.3, {display: 'nonr', autoAlpha: 0});
                this.centerBox4Tween = TweenLite.to(this.centerBox2, 0.3, {display: 'nonr', autoAlpha: 0});
                this.centerBox5Tween = TweenLite.to(this.centerBox2, 0.3, {display: 'nonr', autoAlpha: 0});
                this.centerBox6Tween = TweenLite.to(this.centerBox2, 0.3, {display: 'nonr', autoAlpha: 0});
                this.centerBox7Tween = TweenLite.to(this.centerBox2, 0.3, {display: 'nonr', autoAlpha: 0});
                this.centerBox8Tween = TweenLite.to(this.centerBox2, 0.3, {display: 'nonr', autoAlpha: 0});
