...
import { TimelineLite, TimelineMax, CSSPlugin, TweenLite, Elastic, Power1, Bounce, SlowMo } from "gsap";
...
class MenuPage extends Component {
    ...
    componentDidMount() {
        ...
        setInterval(() => {
            ...
            if(subDeg === 0) {
                this.singleCenterBoxTween = TweenLite.to(this.centerBox1, 0.3, {display: 'block', autoAlpha: 1, ease: new SlowMo(.5, .05, .1, .3)});
            ...
            if(subDeg === 45) {
                ...
                //     })
                // }
                this.singleCenterBoxTween = TweenLite.to(this.centerBox2, 0.3, {display: 'block', autoAlpha: 1, ease: new SlowMo(.5, .05, .1, .3)});
            ...
            if(subDeg === 90) {
                this.singleCenterBoxTween = TweenLite.to(this.centerBox3, 0.3, {display: 'block', autoAlpha: 1, ease: new SlowMo(.5, .05, .1, .3)});
            ...
            if(subDeg === 135) {
                this.singleCenterBoxTween = TweenLite.to(this.centerBox4, 0.3, {display: 'block', autoAlpha: 1, ease: new SlowMo(.5, .05, .1, .3)});
            ...
            if(subDeg === 180) {
                this.singleCenterBoxTween = TweenLite.to(this.centerBox5, 0.3, {display: 'block', autoAlpha: 1, ease: new SlowMo(.5, .05, .1, .3)});
            ...
            if(subDeg === 225) {
                this.singleCenterBoxTween = TweenLite.to(this.centerBox6, 0.3, {display: 'block', autoAlpha: 1, ease: new SlowMo(.5, .05, .1, .3)});
            ...
            if(subDeg === 270) {
                this.singleCenterBoxTween = TweenLite.to(this.centerBox7, 0.3, {display: 'block', autoAlpha: 1, ease: new SlowMo(.5, .05, .1, .3)});
            ...
            if(subDeg === 315) {
                this.singleCenterBoxTween = TweenLite.to(this.centerBox8, 0.3, {display: 'block', autoAlpha: 1, ease: new SlowMo(.5, .05, .1, .3)});
