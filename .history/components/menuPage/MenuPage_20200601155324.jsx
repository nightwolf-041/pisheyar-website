...
import { TimelineLite, TimelineMax, TweenMax, TweenLite, Bounce, Elastic } from "gsap";
...
class MenuPage extends Component {
    ...
    componentDidMount() {
        ...
        this.menuPageInterval = setInterval(() => {
            ...
            this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 1, {rotation: -this.state.deg, ease: Elastic.easeOut.config( 1, 0.5)});
    ...
    handleTurn = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 1.2, {rotation: 0, ease: Elastic.easeOut.config( 0.8, 0.3)});
    ...
    handleTurn2 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 1.2, {rotation: -45, ease: Elastic.easeOut.config( 0.8, 0.3)});
    ...
    handleTurn3 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 1.2, {rotation: -90, ease: Elastic.easeOut.config( 0.8, 0.3)});
    ...
    handleTurn4 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 1.2, {rotation: -135, ease: Elastic.easeOut.config( 0.8, 0.3)});
    ...
    handleTurn5 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 1.2, {rotation: -180, ease: Elastic.easeOut.config( 0.8, 0.3)});
    ...
    handleTurn6 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 1.2, {rotation: -225, ease: Elastic.easeOut.config( 0.8, 0.3)});
    ...
    handleTurn7 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 1.2, {rotation: -270, ease: Elastic.easeOut.config( 0.8, 0.3)});
    ...
    handleTurn8 = () => {
        ...
        this.circleMenuMainTween = TweenLite.to(this.circleMenuMain, 1.2, {rotation: -315, ease: Elastic.easeOut.config( 0.8, 0.3)});
