...
class MenuPageSearch extends Component {
    ...
    // countries
        ...
        // axios.get(
        //     'http://185.94.97.164/api/Category/SearchByCity?cityGuid=72ef30ac-b5e1-4302-8133-867379963c92&searchInput=مصنوعات صنعتی',
        //   ).then((res) => {
        //     console.log(res);
        //     if(res.data.state === 1) {
        //         this.setState({
    ...
    serachHandler = (e) => {
        ...
        if(e.target.value !== ''){
            ...
            this.searchRowMobileTween = TweenLite.to(this.searchRowMobile, 0.2, {borderBottomRightRadius: 0, borderBottomLeftRadius: 0})
        }
        if(e.target.value === ''){
            this.searchResultBoxTween = TweenLite.to(this.searchResultBox, 0.2, {autoAlpha: 0, display: 'none'})
            this.searchRowTween = TweenLite.to(this.searchRow, 0.2, {borderBottomRightRadius: '1rem', borderBottomLeftRadius: '1rem'})
            this.searchRowMobileTween = TweenLite.to(this.searchRowMobile, 0.2, {borderBottomRightRadius: '1rem', borderBottomLeftRadius: '1rem'})
        }
            ...
            <>
                ...
                <div className={classes.menuPageSearchResultBox} ref={div => this.searchResultBox = div}>
                    <h1>
                        ...
                        this.state.serachResultMessage : 
                        // this.state.serachResultCategories.map(ctg => {
                            ...
                            wrapperProps={{
                              ...
                              >
                                <div className={classes.menuPageSearchResultItembox}>
                                    <h2 className={classes.menuPageSearchResultItem}>
                                        ابزار آلات صنعتی منعتی
                                    </h2>
                                </div>
                                <div className={classes.menuPageSearchResultItembox}>
                                    <h2 className={classes.menuPageSearchResultItem}>
