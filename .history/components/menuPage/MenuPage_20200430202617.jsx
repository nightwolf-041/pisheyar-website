...
const MenuPage = () => {
    ...
    return(
        <div id="circleMenuMain" className={classes.circleMenuMain} ref={circleMenuMain}>
            <div id="circleMenuItem1" className={classes.circleMenuItem1} onClick={handleTurn}>
                <div className={classes.circleMenuItemIconbox}>1</div>
            </div>
            <div className={classes.circleMenuItem2} onClick={handleTurn2}>
                <div className={classes.circleMenuItemIconbox}>2</div>
            </div>
            <div className={classes.circleMenuItem3} onClick={handleTurn3}>
                <div className={classes.circleMenuItemIconbox}>3</div>
            </div>
        </div>
    )
}
