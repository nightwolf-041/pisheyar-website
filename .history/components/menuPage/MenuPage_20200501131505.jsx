...
const MenuPage = () => {
    ...
    return(
        <div className={classes.circleMenuMainBox}>
             ...
             className={classes.circleMenuMainImage1} ref={imageee1} />
             <img id="imageee2" src="/about-man.png" alt=""
             className={classes.circleMenuMainImage2} ref={imageee2} />
             <img id="imageee3" src="/Background.png" alt=""
             className={classes.circleMenuMainImage2} ref={imageee3} />
             <img id="imageee4" src="/stock.jpg" alt=""
             className={classes.circleMenuMainImage2} ref={imageee4} />
