...
const MenuPage = () => {
    ...
    let [disablePrev, setDisablePrev] = useState(false)
    ...
    return(
        ...
        <div className={classes.circleMenuMainBox}>
            ...
            ref={nextHandler}>بعدی</button>
             ...
             ref={centerBox1}></div>
             <div id="centerBox2" className={[classes.circleMenuMainCenterBox, classes.classes.circleMenuMainCenterBox2].join(' ')}
             ref={centerBox2}></div>
             <div id="centerBox3" className={[classes.circleMenuMainCenterBox, classes.classes.circleMenuMainCenterBox3].join(' ')}
             ref={centerBox3}></div>
             <div id="centerBox4" className={[classes.circleMenuMainCenterBox, classes.classes.circleMenuMainCenterBox4].join(' ')}
             ref={centerBox4}></div>
             <div id="centerBox5" className={[classes.circleMenuMainCenterBox, classes.classes.circleMenuMainCenterBox5].join(' ')}
             ref={centerBox5}></div>
             <div id="centerBox6" className={[classes.circleMenuMainCenterBox, classes.classes.circleMenuMainCenterBox6].join(' ')}
             ref={centerBox6}></div>
             <div id="centerBox7" className={[classes.circleMenuMainCenterBox, classes.classes.circleMenuMainCenterBox7].join(' ')}
             ref={centerBox7}></div>
             <div id="centerBox8" className={[classes.circleMenuMainCenterBox, classes.classes.circleMenuMainCenterBox8].join(' ')}
             ref={centerBox8}></div>
