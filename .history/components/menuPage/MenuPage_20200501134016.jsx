...
const MenuPage = () => {
    ...
    return(
        <div className={classes.circleMenuMainBox}>
             ...
             className={displayBlock ? classes.circleMenuMainImage1 : classes.circleMenuMainImage1None}
             ref={imageee1} />
             <img id="imageee2" src="/about-man.png" alt=""
             className={displayBlock ? classes.circleMenuMainImageOther : classes.circleMenuMainImageOtherNone}
             ref={imageee2} />
