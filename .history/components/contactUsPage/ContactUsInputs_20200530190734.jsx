...
const ContactUsInputs = () => {
    ...
    const sendData = () => {
        ...
        if(selectedCity.length === 0 || selectedCity === {}){
            setCategoriesValid(false)
        }else{
            setCategoriesValid(true)
        }

        if(nameValue.length !== 0 && emailPattern.test(emailValue) && PhoneValue.length !== 0 && phonePattern.test(PhoneValue) && selectedCity.length !== 0 && selectedCity !== []){
            setNameValid(true)
            setEmailValid(true)
            setPhoneValid(true)
            setCategoriesValid(true)
