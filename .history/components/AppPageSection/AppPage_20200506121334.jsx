...
const AppPageSection = () => {
    ...
    const params = {
        pagination: {
          ...
          slidesPerView: 1,
          spaceBetween: 0,
          getSwiper: (sw) => console.log(sw.touches.currentX),
          on: {
            slideChange: (activeIndex) => console.log('activeIndex')
          },
          slideChange: () => console.log('object')
        //   onSlideChange: (sw) => console.log(sw),
