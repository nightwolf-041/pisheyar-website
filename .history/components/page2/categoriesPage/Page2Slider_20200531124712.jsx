...
function Page2Slider(props) {
    ...
    return (
        ...
        {props.data !== null && props.data !== [] && props.data.length > 3 ?
                            ...
                            props.data.map(dt => {
                                <div className={classes.page2SliderItem}>
                                    ...
                                    <div className={classes.page2SliderItemButtonBox}>
                                        <Link
                                        href={`/category/[name]/[id].js`} as={`/category/${dt.title}/${dt.categoryGuid}`}>
                ...
                {props.data !== null && props.data !== [] ?
                    props.data.map(dt => (
                        <div className={classes.page2SliderItemLess}>
                            ...
                            <div className={classes.page2SliderItemButtonBox}>
                                <Link
                            href={`/category/[name]/[id].js`} as={`/category/nnn/${dt.categoryGuid}`}>
                                    <a className={classes.page2SliderItemButton}>
                                        جزئیات
                                    </a>
                                </Link>
