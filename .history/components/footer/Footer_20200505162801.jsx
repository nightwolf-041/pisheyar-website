...
import { faAngleLeft, faUserClock, faAddressBook } from "@fortawesome/free-solid-svg-icons";
                    ...
                    <div className={classes.footerLogobox}>
                        ...
                        <div className={classes.footerAddressbox}>
                            <div className={classes.footerAddressboxItem}>
                                <FontAwesomeIcon icon={faAddressBook} className={classes.footerAddressboxItemIcon} />
