                ...
                <div className={classes.footerTop}>
                    ...
                    <div className={classes.footerLinksbox}>
                        ...
                        <div className={classes.footerLinksboxLinkbox}>
                            ...
                            smooth={true} duration={500} className={classes.footerLinksboxLink}>اپلیکیشن</Link>
                            <Link activeClass={classes.activeLink} to="blogPage" spy={true}
                            smooth={true} duration={500} className={classes.footerLinksboxLink}>بلاگ</Link>
                            <Link activeClass={classes.activeLink} to="contactUsPage" spy={true}
                            smooth={true} duration={500} className={classes.footerLinksboxLink}>ارتباط با ما</Link>
                        </div>
                    </div>
                </div>
