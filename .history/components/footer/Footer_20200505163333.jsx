...
import { faAngleLeft, faPhoneAlt, faSearchLocation, faPaintBrush, faPaperPlane } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className={classes.footerTop}>
                    <div className={classes.footerLogobox}>
                        ...
                        <div className={classes.footerAddressbox}>
                            ...
                            <div className={classes.footerAddressboxItem}>
                                <FontAwesomeIcon icon={faPaperPlane} className={classes.footerAddressboxItemIcon} />
                                <span className={classes.footerAddressboxItemSpan}>
