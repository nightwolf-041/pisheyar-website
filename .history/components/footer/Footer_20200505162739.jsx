...
import { faAngleLeft, faUserClock, faAddress } from "@fortawesome/free-solid-svg-icons";
                    ...
                    <div className={classes.footerLogobox}>
                        ...
                        <div className={classes.footerAddressbox}>
                            <div className={classes.footerAddressboxItem}>
                                <FontAwesomeIcon icon={faAddress} className={classes.footerAddressboxItemIcon} />
