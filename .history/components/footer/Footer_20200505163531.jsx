...
import { faAngleLeft, faPhoneAlt, faSearchLocation, faNewspaper } from "@fortawesome/free-solid-svg-icons";
import { faInstagram, faWhatsappSquare } from "@fortawesome/free-brands-svg-icons";
                    ...
                    <div className={classes.footerLogobox}>
                        ...
                        <div className={classes.footerAddressbox}>
                            <div className={classes.footerAddressboxItem}>
                                <FontAwesomeIcon icon={faSearchLocation} className={classes.footerAddressboxItemIcon} />
                            ...
                            <div className={classes.footerAddressboxItem}>
                                <FontAwesomeIcon icon={faNewspaper} className={classes.footerAddressboxItemIcon} />
                                <span className={classes.footerAddressboxItemSpan}>
                            ...
                            <div className={classes.footerAddressboxSocialsbox}>
                                ...
                                <FontAwesomeIcon icon={faWhatsappSquare} className={classes.footerAddressboxSocialIcon} />
                            </div>
                        </div>
                    </div>
