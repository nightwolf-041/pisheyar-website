...
const IndexPage = () => {
  ...
  let [showHide, setShowHide] = useState('twoThree') 
      ...
      <Head>
        ...
        <div className={classes.homeHeader}>
          ...
          <div className="container">
            ...
            {
              showHide === 'ThreeOne' ?
              <div className={classes.homeHeaderImagesbox} ref={headerImage2box}>
            ...
            {
              showHide === 'ThreeOne' ?
              <div className={classes.homeHeaderImagesbox} ref={headerImage3box}>
