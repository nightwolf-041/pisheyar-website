      ...
      <Head>
        ...
        <div className={classes.homeHeader}>
          ...
          <div className="container">
            ...
            <div className={classes.homeHeaderButtonbox} ref={headerButtonbox1}>
            ...
            <div className={classes.homeHeaderButtonbox2} ref={headerButtonbox2}>
            ...
            <div className={classes.homeHeaderButtonbox3} ref={headerButtonbox3}>
