...
const page2 = (props) => {
  ...
  return (
    <>
      ...
      <Page2TopPage data={props.data} />
      <CategoriesPage data={props.data} givenGuid={givenGuid} />
      <ContactUsPage />
...
page2.getInitialProps = async (ctx) => {
  const res = await axios.get(`http://185.94.97.164/api/Category/GetPrimaries?guid=${router.query.id}`)
