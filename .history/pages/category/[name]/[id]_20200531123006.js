...
const page2 = (props) => {
    ...
    return ( <
        ...
        <
        Page2TopPage bigData = { props.bigData }
        data = { props.data }
        /> <
        CategoriesPage bigData = { props.bigData }
        data = { props.data }
        givenGuid = { givenGuid }
        /> <
        ContactUsPage / >
        ...
        className = { classes.page2PlusIocn }
        /> <
        /div> <
        />
    )
...
page2.getInitialProps = async({ query }) => {
    ...
    const res = await axios.get(`http://185.94.97.164/api/Category/GetPrimaries?guid=${id}`)
