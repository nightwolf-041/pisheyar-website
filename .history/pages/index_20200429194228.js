...
const IndexPage = () => {
  ...
  let [showHide, setShowHide] = useState('two') 
      ...
      <Head>
        ...
        <div className={classes.homeHeader}>
          ...
          <div className="container">
            ...
            style={showHide === 'one' ? {display: 'block'} : {display: 'none'}}>
            ...
            style={showHide === 'two' ? {display: 'block'} : {display: 'none'}}>
            ...
            style={showHide === 'three' ? {display: 'block'} : {display: 'none'}}>
